...
class CircleCommand{
  ...
  setLocation(e) {
    ...
    this.xcord = e.clientX - bounds.left;
    this.ycord = e.clientY - bounds.top;
  }
...
class LineCommand{
  ...
  setLocation(e){
    this.endx = e.clientX - bounds.left;
    this.endy = e.clientY - bounds.top;
